...
//            dic.setVariable("SCREEN_CUSTOM_CSS", Config.getParam("css_version", "SCREEN_CUSTOM_CSS"));
...
////                dic.setVariable("VIDEO_SRC", og.VideoSource);
////                dic.setVariable("VIDEO_WIDTH", og.VideoWidth);
////                dic.setVariable("VIDEO_HEIGHT", og.VideoHeight);
////                dic.setVariable("VIDEO_TYPE", og.VideoType);
...
//                dic.setVariable("OG_TWITTER_TITLE", og.OgTwitterTitle);
//                dic.setVariable("OG_TWITTER_DESCRIPTION", og.OgTwitterDescription);
//                dic.setVariable("OG_GOOGLE_TITLE", og.OgGoogleTitle);
//                dic.setVariable("OG_GOOGLE_DESCRIPTION", og.OgGoogleDescription);
//
//                if (og.OgFBEnable == true) {
//                    dic.addSection("OG_FB");
//                    dic.setVariable("OG_FB_URL", og.OgFBUrl);
//                    dic.setVariable("OG_FB_SITE_NAME", og.OgFBSiteName);
////                    dic.setVariable("OG_FB_TYPE", og.OgFBType);
////                    dic.setVariable("OG_FB_VIDEO", og.OgFBVideo);
////                    dic.setVariable("OG_FB_VIDEO_SECURE", og.OgFBVideoSecure);
////                    dic.setVariable("OG_FB_VIDEO_TYPE", og.OgFBVideoType);
////                    dic.setVariable("OG_FB_VIDEO_WIDTH", og.OgFBVideoWidth);
////                    dic.setVariable("OG_FB_VIDEO_HEIGHT", og.OgFBVideoHeight);
//                    //dic.setVariable("META_TEST", og.OgFBAudioSecure);
//                }
//
//                if (og.OgTwitterEnable == true) {
//                    dic.addSection("OG_TWITTER");
//                    dic.setVariable("OG_TWITTER_URL", og.OgTwitterUrl);
//                    dic.setVariable("OG_TWITTER_CARD", og.OgTwitterCard);
//                    dic.setVariable("OG_TWITTER_SITE", og.OgTwitterSite);
//                    dic.setVariable("OG_TWITTER_PLAYER", og.OgTwitterPlayer);
//                    dic.setVariable("OG_TWITTER_PLAYER_WIDTH", og.OgTwitterPlayerWidth);
//                    dic.setVariable("OG_TWITTER_PLAYER_HEIGHT", og.OgTwitterPlayerHeight);
//                }
//            }
//        } catch (Exception ex) {
//            _logger.error(LogUtil.stackTrace(ex));
