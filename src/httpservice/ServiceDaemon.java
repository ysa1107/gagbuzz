...
//        rewriteHandler.addRule(rewriteRegexRule_shorten_withPrams);
        ...
        //hard code for event depcatinh.purite
//        RewriteRegexRule rewriteRegexRule_shorten_depcatinh = new RewriteRegexRule();
//        rewriteRegexRule_shorten_depcatinh.setRegex("^/depcatinh.purite$");
//        rewriteRegexRule_shorten_depcatinh.setReplacement("/dispatch?s=depcatinh.purite");
//        rewriteHandler.addRule(rewriteRegexRule_shorten_depcatinh);
//
//        RewriteRegexRule rewriteRegexRule_shorten_depcatinh_withPrams = new RewriteRegexRule();
//        rewriteRegexRule_shorten_depcatinh_withPrams.setRegex("^/depcatinh.purite/([0-9a-zA-Z-_.]+)$");
//        rewriteRegexRule_shorten_depcatinh_withPrams.setReplacement("/dispatch?s=depcatinh.purite&p=$1");
//        rewriteHandler.addRule(rewriteRegexRule_shorten_depcatinh_withPrams);
